...
| Application    | Regras de negocio simples (unicidade, estado atual)    | Service logic                                                | Email ja existe no cluster; no minimo 1 no ativo       |
...
| archive    | 5 GB   | `application/zip`, `application/gzip`, `application/x-tar`, `application/x-apple-diskimage`                            |
