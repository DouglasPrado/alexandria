...
- Cluster precisa de minimo 1 no ativo para aceitar uploads (RN-N6)
...
- Documentos nao passam por otimizacao nem geram preview — optimized_size = original_size (RN-F3)
...
| type         | enum     | sim         | `thumbnail`, `video_preview`                              | Tipo de preview (somente foto e video)             |
...
| RN-N6  | Minimo 1 no ativo para aceitar uploads (replicacao conforme nos disponiveis, alvo 3x) | Alta       | Node         | Service             |
...
| RN-F3  | Documentos nao passam por otimizacao nem geram preview                        | Baixa      | File         | Service (Pipeline)  |
...
| RN-P2  | Tamanho alvo: foto ~50KB WebP; video 480p ~5MB MP4. Documentos nao geram preview | Media      | Preview      | Service (Pipeline)  |
