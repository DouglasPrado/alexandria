...
| Vault | Cofre criptografado que armazena tokens, credenciais e chaves; desbloqueado via master key |
...
- **RN5:** Tokens OAuth e credenciais de provedores vivem exclusivamente no vault criptografado
