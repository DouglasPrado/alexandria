...
**Responsabilidade:** Armazena credenciais, chaves e senhas de cada membro individualmente. Cada membro possui seu próprio vault. Desbloqueado em memória via senha do membro.
...
| Vault individual por membro como arquivo criptografado | HashiCorp Vault / cloud KMS   | Simples; sem dependência externa; cada membro tem seu vault desbloqueado pela sua senha; master key usada em recovery |
