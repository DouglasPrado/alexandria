...
- [ ] Vault criptografado individual por membro para tokens, credenciais e senhas (desbloqueado via senha do membro)
...
| Segurança | Tokens OAuth/credenciais/senhas | Nunca em texto puro; vault criptografado por membro |
