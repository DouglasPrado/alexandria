...
| ID     | Descrição                                                                                                                       | Prioridade | Status   | Objetivo |
| ------ | ------------------------------------------------------------------------------------------------------------------------------- | ---------- | -------- | -------- |
| RF-062 | Documentos (não mídia) fazem bypass de otimização e preview — chunk e distribui diretamente, sem gerar preview                  | Must       | Proposto | OBJ-01   |
| RF-063 | Formatos aceitos para documentos: PDF, DOCX, XLSX, PPTX, TXT, MD, JSON, SQL, CSV, XML, ZIP, RAR, 7Z, DMG e qualquer arquivo genérico | Must       | Proposto | OBJ-05   |
...
| RF-067 | Classificação automática de media_type baseada em MIME type: image/_ → foto, video/_ → video, demais → documento                | Must       | Proposto | OBJ-01   |
