...
| `feedback.error.insufficientNodes` | Nos insuficientes para replicacao. Adicione pelo menos 3 nos ao cluster. | AlertBanner |
...
| Cluster sem nos | `empty.nodes.title` | Nenhum no configurado | `empty.nodes.body` | Adicione pelo menos 3 nos para comecar a salvar arquivos com replicacao. | Adicionar no |
