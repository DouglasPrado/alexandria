...
| Empty state descricao    | `nodes.empty.description`          | Adicione pelo menos 1 no para comecar a fazer uploads.      | Descricao                    |
| Empty state CTA          | `nodes.empty.cta`                  | Adicionar primeiro no                                       | Botao                        |
| Aviso minimo nos         | `nodes.warning.minNodes`           | Voce precisa de pelo menos 1 no ativo para fazer uploads    | Banner de aviso              |
...
| `feedback.error.nodeMinimum`         | Nao e possivel remover — minimo de 1 no necessario.                                      | Remover com <1 no (RN-N6)                 |
...
| Nos vazios            | Nenhum no registrado              | Adicione pelo menos 1 no para comecar.                   | Adicionar no     |
...
| Use pontuacao em frases e descricoes completas        | Adicione pelo menos 1 no para comecar.          | Adicione pelo menos 1 no para comecar                             |
