...
| Erro nos insuficientes   | `nodes.detail.errorMinNodes`     | Nao e possivel remover — minimo de 1 no necessario                                           | Alert de erro    |
...
| `feedback.error.nodesInsufficient`       | Armazenamento indisponivel. O cluster precisa de ao menos 1 no ativo.      | Toast                              |
| `feedback.error.clusterFull`             | O cluster esta sem espaco. Fale com o administrador.                       | Toast                              |
| `feedback.error.cannotRemoveNode`        | Nao e possivel remover — minimo de 1 no necessario para replicacao.        | Alert                              |
