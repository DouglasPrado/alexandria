...
export type DomainEvent = ClusterCreatedEvent | ClusterRecoveredEvent | MemberJoinedEvent | MemberRemovedEvent | NodeRegisteredEvent | NodeSuspectEvent | NodeLostEvent | NodeDrainedEvent | FileUploadedEvent | FileProcessedEvent | FileCorruptedEvent | PreviewGeneratedEvent | ManifestCreatedEvent | ManifestReplicatedEvent | ChunkCreatedEvent | ChunkReplicatedEvent | ChunkCorruptedEvent | ChunkRepairedEvent | ChunkOrphanedEvent | VaultCreatedEvent | VaultReplicatedEvent | AlertCreatedEvent | AlertResolvedEvent | InviteCreatedEvent | InviteAcceptedEvent;
